#!/bin/sh
#SBATCH -J gen_1klabels_head_tail                   #job name
#SBATCH --time=04-00:20:00          #requested time (DD-HH:MM:SS)
...
#SBATCH --output=gen_1klabels_head_tail.%j.%N.out   #saving standard output to file, %j=JOBID, %N=NodeName
#SBATCH --error=gen_1klabels_head_tail.%j.%N.err    #saving standard error to file, %j=JOBID, %N=NodeName
...
python /cluster/home/czhao07/CS150_DGL_CallGraphClassification/src/generate_more_labels.py
